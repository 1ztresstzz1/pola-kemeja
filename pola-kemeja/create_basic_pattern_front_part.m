...
if pattern.construction_dimensions.neckline == 0 % round neckline 
    ...
    pattern.basic_pattern = [pattern.basic_pattern; pattern.construction_points.F+[0 -3.5]; pattern.construction_points.a4+[0 -3.5]; PL];
    ...
    pattern.basic_pattern = [pattern.basic_pattern; pattern.construction_points.F+[0 -3.5]; [-10 -3.5]; PL(:,1:2)];
    %parameters for cuffs neckline
    pattern.construction_dimensions.necklength_front = PLCurveLength(PL);
...
%% hem
pattern.basic_pattern = [pattern.basic_pattern; pattern.construction_points.F; pattern.construction_points.a4];
pattern.basic_pattern = [pattern.basic_pattern; pattern.construction_points.F; pattern.construction_points.F+[0 -4]];
