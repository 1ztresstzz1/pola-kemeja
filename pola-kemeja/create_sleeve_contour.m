...
pattern.construction_points.sA = [0 human.circumference_upper_arm/3+1.5];
...
pattern.construction_points.sD = [human.circumference_upper_arm/2 human.circumference_upper_arm/3+1.5];
...
y = 0;
pattern.construction_points.sE = [human.circumference_upper_arm y];
...
x = (pattern.construction_points.sD(1)/2)/(pattern.construction_points.sD(1)+pattern.construction_dimensions.cm_ss)*pattern.construction_points.sD(1);
